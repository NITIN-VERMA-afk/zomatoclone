    ...
    <>
      ...
      <div className="card-containers">
        <Card
          ...
          peragraph="Help users discover your place by creating a listing on Zomato"
        />
        <Card
          name="step2"
          title="Register for online ordering"
          peragraph=" And deliver orders to millions of customers with ease"
        />
        <Card
          name="step3"
          title="Start receiving orders online"
          peragraph="Manage orders on our partner app, web dashboard or API partners"
        />
      </div>
      <div className="section-5">
        ...
        <span className="">
          <button className="delhi-ncr">Delhi ncr</button>{" "}
          <input
            className="delhi-ncr-input"
            placeholder="search for your restaurent ,eg Greenland cafe"
            type="search"
            name=""
            id=""
          />{" "}
      ...
      <div className="frequently">
        ...
        <p style={more ? { display: "block" } : { display: "none" }}>
          Creating a restaurant page on Zomato is free of cost. You can maintain
          your page by replying to reviews and do a lot more without any
          charges.
        </p>
      </div>
      <div className="frequently">
        ...
        <p style={more2 ? { display: "block" } : { display: "none" }}>
          Creating a restaurant page on Zomato is free of cost. You can maintain
          your page by replying to reviews and do a lot more without any
          charges.
        </p>
      ...
      <div className="frequently">
        ...
        <p style={more3 ? { display: "block" } : { display: "none" }}>
          Creating a restaurant page on Zomato is free of cost. You can maintain
          your page by replying to reviews and do a lot more without any
          charges.
        </p>
      ...
      <div className="frequently">
        ...
        <p style={more4 ? { display: "block" } : { display: "none" }}>
          Creating a restaurant page on Zomato is free of cost. You can maintain
          your page by replying to reviews and do a lot more without any
          charges.
        </p>
